...
#ifdef UNICODE
#define tchar_to_utf8_size(wbuf) (WideCharToMultiByte(CP_UTF8, 0, wbuf, -1, NULL, 0, NULL, NULL))
#else
#define tchar_to_utf8_size(wbuf) (lstrlen(wbuf) + 1)
#endif

#ifdef UNICODE
#define tchar_to_utf8(wbuf, ret, len) (WideCharToMultiByte(CP_UTF8, 0, wbuf, -1, ret, len, NULL, NULL))
#else
#define tchar_to_utf8(wbuf, ret, len) (str_cpy_n_t(ret, wbuf, len))
#endif
...
#ifdef UNICODE
#define utf8_to_tchar_size(buf) (MultiByteToWideChar(CP_UTF8, 0, buf, -1, NULL, 0))
#else
#define utf8_to_tchar_size(buf) (lstrlen(buf) + 1)
#endif

#ifdef UNICODE
#define utf8_to_tchar(buf, wret, len) (MultiByteToWideChar(CP_UTF8, 0, buf, -1, wret, len))
#else
#define utf8_to_tchar(buf, wret, len) (str_cpy_n_t(wret, buf, len))
#endif
...
TCHAR* alloc_utf8_to_tchar(char* str);
#else
