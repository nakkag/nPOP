...
BOOL ini_read_setting(HWND hWnd)
{
	...
	op.MainRect.left = Scale(profile_get_int(GENERAL, TEXT("left"), 0, app_path));
	op.MainRect.top = Scale(profile_get_int(GENERAL, TEXT("top"), 0, app_path));
	op.MainRect.right = Scale(profile_get_int(GENERAL, TEXT("right"), 440, app_path));
	op.MainRect.bottom = Scale(profile_get_int(GENERAL, TEXT("bottom"), 320, app_path));
	...
	op.LvColSize[0] = Scale(profile_get_int(GENERAL, TEXT("LvColSize-0"), 150, app_path));
	op.LvColSize[1] = Scale(profile_get_int(GENERAL, TEXT("LvColSize-1"), 100, app_path));
	op.LvColSize[2] = Scale(profile_get_int(GENERAL, TEXT("LvColSize-2"), 110, app_path));
	op.LvColSize[3] = Scale(profile_get_int(GENERAL, TEXT("LvColSize-3"), 50, app_path));

	op.AddColSize[0] = Scale(profile_get_int(GENERAL, TEXT("AddColSize-0"), 250, app_path));
	op.AddColSize[1] = Scale(profile_get_int(GENERAL, TEXT("AddColSize-1"), 190, app_path));

	op.ViewRect.left = Scale(profile_get_int(GENERAL, TEXT("viewleft"), 0, app_path));
	op.ViewRect.top = Scale(profile_get_int(GENERAL, TEXT("viewtop"), 0, app_path));
	op.ViewRect.right = Scale(profile_get_int(GENERAL, TEXT("viewright"), 450, app_path));
	op.ViewRect.bottom = Scale(profile_get_int(GENERAL, TEXT("viewbottom"), 400, app_path));

	op.EditRect.left = Scale(profile_get_int(GENERAL, TEXT("editleft"), 0, app_path));
	op.EditRect.top = Scale(profile_get_int(GENERAL, TEXT("edittop"), 0, app_path));
	op.EditRect.right = Scale(profile_get_int(GENERAL, TEXT("editright"), 450, app_path));
	op.EditRect.bottom = Scale(profile_get_int(GENERAL, TEXT("editbottom"), 400, app_path));
...
BOOL ini_save_setting(HWND hWnd, BOOL SaveMailFlag)
{
	...
	profile_write_int(GENERAL, TEXT("left"), UnScale(op.MainRect.left), app_path);
	profile_write_int(GENERAL, TEXT("top"), UnScale(op.MainRect.top), app_path);
	profile_write_int(GENERAL, TEXT("right"), UnScale(op.MainRect.right), app_path);
	profile_write_int(GENERAL, TEXT("bottom"), UnScale(op.MainRect.bottom), app_path);
	...
	profile_write_int(GENERAL, TEXT("LvColSize-0"), UnScale(op.LvColSize[0]), app_path);
	profile_write_int(GENERAL, TEXT("LvColSize-1"), UnScale(op.LvColSize[1]), app_path);
	profile_write_int(GENERAL, TEXT("LvColSize-2"), UnScale(op.LvColSize[2]), app_path);
	profile_write_int(GENERAL, TEXT("LvColSize-3"), UnScale(op.LvColSize[3]), app_path);

	profile_write_int(GENERAL, TEXT("AddColSize-0"), UnScale(op.AddColSize[0]), app_path);
	profile_write_int(GENERAL, TEXT("AddColSize-1"), UnScale(op.AddColSize[1]), app_path);

	profile_write_int(GENERAL, TEXT("viewleft"), UnScale(op.ViewRect.left), app_path);
	profile_write_int(GENERAL, TEXT("viewtop"), UnScale(op.ViewRect.top), app_path);
	profile_write_int(GENERAL, TEXT("viewright"), UnScale(op.ViewRect.right), app_path);
	profile_write_int(GENERAL, TEXT("viewbottom"), UnScale(op.ViewRect.bottom), app_path);

	profile_write_int(GENERAL, TEXT("editleft"), UnScale(op.EditRect.left), app_path);
	profile_write_int(GENERAL, TEXT("edittop"), UnScale(op.EditRect.top), app_path);
	profile_write_int(GENERAL, TEXT("editright"), UnScale(op.EditRect.right), app_path);
	profile_write_int(GENERAL, TEXT("editbottom"), UnScale(op.EditRect.bottom), app_path);
