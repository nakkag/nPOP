...
#define STR_ERR_SENDLOCK			TEXT("Cannot send while another send/receive is in progress")

// Socket error
#define STR_ERR_SOCK_SELECT			TEXT("'select' failed")
...
#define STR_ERR_SOCK_GETIPADDR		TEXT("Unable to find the mail server\nPlease check the server name")
...
#define STR_ERR_SOCK_RESPONSE		TEXT("Could not parse the response\n\n")
...
#define STR_ERR_SOCK_MAILSYNC 		TEXT("Mail numbers not synchronised\n\n")\
									TEXT("Check for new mail to synchronise the mail numbers")
...
#define STR_ERR_SOCK_BADPASSWORD	TEXT("Incorrect username or password\n\n")
...
#define STR_ERR_SOCK_BADFROM		TEXT("The sender's mail address is not set correctly")
#define STR_ERR_SOCK_HELO 			TEXT("HELO failed\n")\
									TEXT("Please check that the sender's mail address is set correctly\n\n")
...
#define STR_ERR_SOCK_RCPTTO			TEXT("RCPT TO failed\n")\
									TEXT("Please check that the recipient's mail address is set correctly\n\n")
#define STR_ERR_SOCK_DATA			TEXT("DATA failed\n\n")
#define STR_ERR_SOCK_MAILSEND		TEXT("Mail not sent\n\n")
#define STR_ERR_SOCK_SSL_INIT		TEXT("SSL initialization failed")
#define STR_ERR_SOCK_SSL_VERIFY		TEXT("Server certificate verification failed")

// Question
#define STR_Q_DELETE				TEXT("Delete it?")
#define STR_Q_DELSERVERMAIL			TEXT("Some mail will be deleted from the server.  Proceed?")
...
#define STR_Q_DELMAILBOX			TEXT("Delete the currently displayed account?")
#define STR_Q_DELATTACH				TEXT("Delete attached files?")
#define STR_Q_COPY					TEXT("Copy %d mail to the Savebox?")
#define STR_Q_DEPENDENCE			TEXT("The text contains platform-dependent characters.  Proceed?")
...
#define STR_Q_NEXTFIND				TEXT("Reached the end of the search.\nSearch again from the beginning?")
#define STR_Q_EDITCANSEL			TEXT("Cancel the edit?")
#define STR_Q_SENDMAIL				TEXT("Send it?")
#define STR_Q_ATTACH				TEXT("If the attached file contains a virus or similar,\n")\
									TEXT("it may damage your computer.\n\n")\
...
#define STR_MSG_NOBODY				TEXT("Message body not downloaded. Cannot be opened\n\n")\
									TEXT("Use 'Mark for download' and then 'Update marked items'\n")\
									TEXT("to download the body")
...
#define STR_STATUS_SSL				TEXT("SSL connecting...")
#define STR_STATUS_SSL_COMPLETE		TEXT("SSL connected")
...
#define STR_FILTER_UNRECV			TEXT("Do not download")
